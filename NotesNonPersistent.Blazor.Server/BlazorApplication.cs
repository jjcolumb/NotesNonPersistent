...
namespace NotesNonPersistent.Blazor.Server {
    public partial class NotesNonPersistentBlazorApplication : BlazorApplication {
        public NotesNonPersistentBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void NotesNonPersistentBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
